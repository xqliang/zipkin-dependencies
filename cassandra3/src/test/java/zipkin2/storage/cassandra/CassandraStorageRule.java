...
public class CassandraStorageRule extends ExternalResource {
  ...
  CassandraStorageRule(String image, String keyspace) {
    this.image = image;
  ...
  CassandraStorage tryToInitializeStorage() {
    CassandraStorage result = CassandraStorage.newBuilder()
        .contactPoints(contactPoints())
        .ensureSchema(true)
        .strictTraceId(false) // allows strict trace ID test to pass
